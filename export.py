...
def export_onnx(model, im, file, opset, train, dynamic, simplify, prefix=colorstr('ONNX:')):
    ...
    try:
        ...
        print("========ONNX Check End==========")
        
        print("===============JIT Trace Start==============")
        example_forward_input = torch.randn(1,3,640,640)
        torch.jit.trace(model, example_forward_input)
        print("===============JIT Trace End ===============")
